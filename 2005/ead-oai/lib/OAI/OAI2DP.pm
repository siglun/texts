...
sub new
{
   ...
   my $self = {
	 ...
	 ead          => 'urn:isbn:1-931666-00-8'
      },
      metadataschema => {
         oai_dc       => 'http://www.openarchives.org/OAI/2.0/oai_dc.xsd',
	 marc         => 'http://www.loc.gov/standards/marcxml/schema/MARC21slim.xsd',
	 ead          => 'http://diglib.princeton.edu/ead/dtd/2002/ead.xsd'
      },
      metadataroot => {
         oai_dc       => 'dc',
	 marc         => 'record',
...
sub MetadataFormatisValid
{
   ...
   my $found = 0;
   $metadataFormat = 'oai_dc' unless $metadataFormat;
...
sub FormatRecord
{
   ...
   my $header = $self->FormatHeader($identifier,
				    $datestamp,
				    $status,
				    $setSpecs);
...
sub Identify
{
   ...
   $identity->{'earliestDatestamp'} = "1990-01-01";
   ...
   my $desc = {
      'toolkit' => [[ 
         ...
         {
            'title'    => 'Ediffahprojektet tillgängliggör arkivinformation från svenska forskningsbibliotek',
            'author'   => {
               'name' => 'Sigfrid Lundberg',
               'email' => 'sigfrid.lundberg@lub.lu.se',
