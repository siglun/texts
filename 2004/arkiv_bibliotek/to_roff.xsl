...
<xsl:template match="p[@class='navigation']" />
...
.\" An ordered list is coming
<xsl:for-each select="li"><xsl:text>
.IP </xsl:text><xsl:value-of select="position()"/><xsl:text>
...
<!--
	...
	$Log$
	Revision 1.1  2009/06/29 11:04:25  sigfrid
	Initial revision
