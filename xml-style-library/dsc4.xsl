...
<!--
   ...
   such as a series, subseries, subgroup or subcollection and does not have
   container elements associated with it. However, it does accommodate
   situations there there a c01 that is a file is occasionally interspersed.
   However, if c01 is always a file, use dsc10.xsl instead.
...
-->
  ...
  <xsl:template name="component-did">
    ...
    <!--This choose statement selects between cases where unitdate is a
     child of unittitle and where it is a separate child of did.-->
	...
	<xsl:apply-templates
	  select="unittitle/text()| unittitle/*[not(self::unitdate)]"/>
	<xsl:text>&#x20;</xsl:text>
  ...
  <xsl:template name="c02-level-container">
	...
	select="preceding::did[1]/container[@type='Box' or @type='Oversize' or
  ...
  <xsl:template name="c03-level">
	...
	@type='Volume' or @type='Carton' or @type='Reel']"/> 
      ...
      <xsl:variable name="preceding"
	select="preceding::did[1]/container[@type='Box' or @type='Volume' or
	@type='Carton' or @type='Reel']"/> 
