...
.TL
.hy 0
<xsl:value-of select="titlePage/docTitle/titlePart" />
.hy 1
<xsl:for-each select="titlePage/byline/docAuthor/name">
<xsl:choose>
...
<!--
	...
	$Log$
	Revision 1.1  2009/06/29 11:06:28  sigfrid
	Initial revision

	Revision 1.5  2002/11/19 08:57:17  sigge
	Have modify this document, so that it follows the DTD, and such that
	I can use my current style-sheets
